...
export const forumAbi = [
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'commentCount', internalType: 'uint256', type: 'uint256' },
      { name: 'shareCount', internalType: 'uint256', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_description', internalType: 'string', type: 'string' },
      { name: '_spoil', internalType: 'bool', type: 'bool' },
      { name: '_mood', internalType: 'string', type: 'string' },
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'shareCount', internalType: 'uint256', type: 'uint256' },
          { name: 'timestamp', internalType: 'uint256', type: 'uint256' },
          { name: 'mood', internalType: 'string', type: 'string' },
...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link forumAbi}__ and `functionName` set to `"dailyLimit"`
 */
export const useReadForumDailyLimit = /*#__PURE__*/ createUseReadContract({
  abi: forumAbi,
  functionName: 'dailyLimit',
})

/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link forumAbi}__ and `functionName` set to `"dailyPosts"`
 */
export const useReadForumDailyPosts = /*#__PURE__*/ createUseReadContract({
  abi: forumAbi,
  functionName: 'dailyPosts',
})
...
/**
 * Wraps __{@link useWriteContract}__ with `abi` set to __{@link forumAbi}__ and `functionName` set to `"incrementShareCount"`
 */
export const useWriteForumIncrementShareCount =
  /*#__PURE__*/ createUseWriteContract({
    abi: forumAbi,
...
/**
 * Wraps __{@link useSimulateContract}__ with `abi` set to __{@link forumAbi}__ and `functionName` set to `"incrementShareCount"`
 */
export const useSimulateForumIncrementShareCount =
  /*#__PURE__*/ createUseSimulateContract({
    abi: forumAbi,
    functionName: 'incrementShareCount',
  })
